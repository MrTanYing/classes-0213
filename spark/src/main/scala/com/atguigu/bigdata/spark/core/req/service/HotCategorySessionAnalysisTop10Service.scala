...
import com.atguigu.bigdata.spark.core.req.dao.{HotCategoryAnalysisTop10Dao, HotCategorySessionAnalysisTop10Dao}
import com.atguigu.bigdata.spark.core.req.helper.HotCategoryAccumulator
